...
* [Порождающие шаблоны](#Порождающие-Шаблоны-Проектирования)
 ...
 * [Простая фабрика](#-Простая-фабрика-англ-simple-factory)
...
> Представьте, вы строите дом и вам нужны двери. Это было бы не оправданно, если бы каждый раз, когда вам требуется дверь, вы бы надевали костюм плотника и начинали делать дверь самостоятельно. Вместо этого, дверь для вас могут сделать на фабрике.
